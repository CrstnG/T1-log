    ...
    if (j == h){
        ...
        for (auto &entries: tree->keys){
            ...
            if(entries.child == nullptr){
				//cout <<"UN NULL EN SEARCH HEIGHTTTTT"<<endl;
				}
            else{
    ...
    if (n <= B){
       ...
       // cout << largo_tj << endl;
        ...
        for (auto &sub_tree : tree_T_j){
           // cout<<"ALTURAS DE SUBTREE:"<<endl;
            if(sub_tree == nullptr){
             ...
             //   cout<<"ESTOY BORRANDO UN NULL"<<endl;
        ...
        for (auto &idx_2 : null_elim){
			//cout<<"borrando indices nullos"<<endl;
        ...
        //h = *min_iter;
        //cout <<conjunto_F.size()<<endl;
       // cout <<tree_T_j.size()<<endl;
